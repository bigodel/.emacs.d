...
Configure the preferred modeline package. I'm currently using the
=doom-modeline= just because it is pretty awesome, very pretty and quite light
(not as light as something like =smart-mode-line=, but still lighter than
=spaceline=).
