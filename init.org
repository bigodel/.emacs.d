...
With this, pressing =ESC= actually leaves the minibuffer. Also, like in Vim's
"minibuffer", pressing =C-w= deletes a word back.
...
More configuration regarding a bunch of packages and modes.
